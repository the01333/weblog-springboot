...
/**
 * @description: AOP 切面，用于记录 API 请求日志
 * @author: YCcLin
 * @date: 2025/1/13
 **/
@Aspect
...
public class ApiOperationLogAspect {
     ...
     */
    @Pointcut("@annotation(com.puxinxiaolin.weblog.common.aspect.ApiOperationLog)")
    ...
    private String getApiOperationLogDescription(ProceedingJoinPoint joinPoint) {
        ...
        // 3. 提取 @ApiOperationLog 注解
        ApiOperationLog apiOperationLog = method.getAnnotation(ApiOperationLog.class);
        // 4. 返回从 @ApiOperationLog 注解中的 description
